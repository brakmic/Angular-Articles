...
module.exports = function(options) {
 ...
 return {
  ...
  entry: {
    ...
    'ngrxintro': AOT ? './src/init/ngrxintro.aot.ts' :
                    './src/init/ngrxintro.ts',
  ...
  resolve: {
    ...
    alias: {
      'jquery': helpers.getRoot('src/vendor/jquery/jquery-2.2.3.min.js'),
      'lodash': helpers.root('node_modules/lodash/index.js'),
      'config.json': helpers.root('src/config.json'),
      'bows': helpers.root('src/vendor/bows/index.js')
    },
  ...
  plugins: [
    ...
    new CheckerPlugin(),
      ...
      new CommonsChunkPlugin({
       ...
       // Specify the correct order the scripts will be injected in
      new CommonsChunkPlugin({
        name: ['vendor','ngrxintro','polyfills']
      }),
