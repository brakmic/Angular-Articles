...
const TITLE = process.env.TITLE || 'ngrx-intro';
...
return webpackMerge(commonConfig({ env: ENV }), {
  ...
  plugins: [
    ...
    */
    ...
    new UglifyJsPlugin({
        beautify: false, //prod
        mangle: false, // disabled for datatables.net
     ...
     */
     ...
     new NormalModuleReplacementPlugin(
      /angular2-hmr/,
       helpers.getRoot('config/modules/angular2-hmr-prod.js')
     ),
